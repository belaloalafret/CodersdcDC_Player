...
public class HomeVideosItems implements Parcelable {
    ...
    public HomeVideosItems() {
    }

    public HomeVideosItems(String title, String description, String file_path, String mime_type) {
        this.title = title;
    ...
    protected HomeVideosItems(Parcel in) {
        id = in.readInt();
        title = in.readString();
    ...
    public static final Creator<HomeVideosItems> CREATOR = new Creator<HomeVideosItems>() {
        @Override
        public HomeVideosItems createFromParcel(Parcel in) {
            return new HomeVideosItems(in);
        }

        @Override
        public HomeVideosItems[] newArray(int size) {
            return new HomeVideosItems[size];
        }
    };
